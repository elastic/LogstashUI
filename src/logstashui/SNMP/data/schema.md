...
Per-entity hardware identity for every physical component (chassis, line cards, modules, transceivers, fans, PSUs). Table: `component`, keyed by `entPhysicalIndex`. Source: **ENTITY-MIB** (RFC 4133).

**Naming authority: openconfig-platform `/components/component/state`.** Where a field has an OpenConfig leaf, the canonical name is that leaf projected to snake_case. Fields with no OpenConfig home keep bespoke ENTITY-MIB names.

| Field | OID | MIB | OpenConfig leaf |
|---|---|---|---|
| `component.name` | `1.3.6.1.2.1.47.1.1.1.1.7` | ENTITY-MIB | `name` (component key) |
| `component.type` | `1.3.6.1.2.1.47.1.1.1.1.5` | ENTITY-MIB | `type` — entPhysicalClass enum: 3=chassis, 6=powerSupply, 7=fan, 9=module, 10=port |
| `component.description` | `1.3.6.1.2.1.47.1.1.1.1.2` | ENTITY-MIB | `description` |
| `component.serial_no` | `1.3.6.1.2.1.47.1.1.1.1.11` | ENTITY-MIB | `serial-no` |
| `component.mfg_name` | `1.3.6.1.2.1.47.1.1.1.1.12` | ENTITY-MIB | `mfg-name` |
| `component.part_no` | `1.3.6.1.2.1.47.1.1.1.1.13` | ENTITY-MIB | `part-no` (entPhysicalModelName) |
| `component.hardware_version` | `1.3.6.1.2.1.47.1.1.1.1.8` | ENTITY-MIB | `hardware-version` |
| `component.firmware_version` | `1.3.6.1.2.1.47.1.1.1.1.9` | ENTITY-MIB | `firmware-version` |
| `component.software_version` | `1.3.6.1.2.1.47.1.1.1.1.10` | ENTITY-MIB | `software-version` |
| `component.mfg_date` | `1.3.6.1.2.1.47.1.1.1.1.17` | ENTITY-MIB | `mfg-date` |
| `component.removable` | `1.3.6.1.2.1.47.1.1.1.1.16` | ENTITY-MIB | `removable` — entPhysicalIsFRU (TruthValue: 1=true, 2=false) |

No OpenConfig leaf (bespoke, keep native): `component.vendor_type` (`…1.1.3`), `component.contained_in` (`…1.1.4`, parent index — OC models this as a parent reference), `component.parent_rel_pos` (`…1.1.6`), `component.alias` (`…1.1.14`), `component.asset_id` (`…1.1.15`), `component.uris` (`…1.1.18`).
