...
def seed_system_policies(apps, schema_editor):
    ...
    simulate_policy, created = Policy.objects.get_or_create(
        ...
        defaults={
            ...
            'is_system': True,
            'settings_path': '/opt/logstash-agent/simulate-{instance_id}/settings',
            'logs_path': '/opt/logstash-agent/simulate-{instance_id}/logs',
            'binary_path': '/usr/share/logstash/bin',
            'data_path': '/opt/logstash-agent/simulate-{instance_id}/data',
            'agent_api_port': 9500,
            'logstash_api_port': 9560,
            'keystore_env_file': '/opt/logstash-agent/simulate-{instance_id}/env',
            'logstash_source': 'SYSTEM',
            'logstash_version': '',
            'logstash_download_dir': '/opt/logstash-agent/logstash-versions',
