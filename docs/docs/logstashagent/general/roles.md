...
> **Paired releases:** LogstashUI **0.5.3** ↔ LogstashAgent **0.5.3** (see [Compatibility](/docs/docs/logstashui/compatibility.md) and [CHANGELOG](https://github.com/elastic/LogstashUI/blob/main/CHANGELOG.md)).
