...
See [CHANGELOG 0.5.2](https://github.com/elastic/LogstashUI/blob/main/CHANGELOG.md) and [agent roles](/docs/docs/logstashagent/general/roles.md) for Packaged/Managed coexistence and VERSION notes.
