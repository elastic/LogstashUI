...
LOGSTASH_CONFIG=../logstashui.yml python manage.py runserver 0.0.0.0:8080
```
#### Windows
```bash
cd LogstashUI/LogstashUI
...
docker build --no-cache -t logstashagent:latest . --build-arg LOGSTASH_CONFIG=../logstashui.yml
